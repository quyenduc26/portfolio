    ...
    >
      <div className="flex w-[90%] flex-col gap-16 md:w-auto">
        ...
        <div className="flex flex-col gap-2 italic text-gray-100 md:gap-1">
          <p>Convergence of professional working skills</p>
          <p>Proactively contribute creativity in the workplace</p>
          <p>Life motto: Don&apos;t say it&apos;s difficult when you&apos;ve never tried</p>
        </div>
      </div>
      <div className="pic-shadow relative z-50 hidden h-[25vw] w-[25vw] overflow-hidden rounded-full outline outline-green md:block">
        <Image
          src={
            "https://res.cloudinary.com/dlqf09guj/image/upload/v1733803447/epbfiime9cwvojy40ssr.jpg"
          }
          height="300"
          width="300"
          quality={100}
