    ...
    <section className="mx-4 mb-16 mt-16 w-auto rounded-lg bg-dark-100/20 p-4 md:mx-auto md:mt-0 md:w-[600px]">
      ...
      <div className="mt-8 flex flex-col gap-0">
        ...
        >
          ...
          <div className="flex w-full flex-col gap-2">
            <div className="flex w-full flex-col gap-2 md:flex-row md:items-center md:justify-between">
              <h3 className="font-bold text-gray-100">CBTW APAC</h3>
              <span className="text-xs text-gray-100">April 2025 - Present</span>
            </div>
        ...
        >
          ...
          <div className="flex w-full flex-col gap-2">
            <div className="flex w-full flex-col gap-2 md:flex-row md:items-center md:justify-between">
              <h3 className="font-bold text-gray-100">Passerelles Numeriques Vietnam</h3>
              <span className="text-xs text-gray-100">Sep 2022 - Present</span>
            </div>
            <p className="text-sm font-medium text-gray-400">
              Senior Student
            </p>
        ...
        >
          ...
          <div className="flex w-full flex-col gap-2">
            <div className="flex w-full flex-col gap-2 md:flex-row md:items-center md:justify-between">
              <h3 className="font-bold text-gray-100">Techzen Limtied Company</h3>
              <span className="text-xs text-gray-100">Jun 2024 - Sep 2024</span>
            </div>
            <p className="text-sm font-medium text-gray-400">
              Software Engineer Intern  - Fullstack
            </p>
