...
function OneTechnology({ tech }: { tech: Technology }) {
  return (
    ...
    >
      <div className="wrapper peer flex-shrink-0">
        <Image
      ...
      <span className="text-[1px] xl:text-[10px] 
          w-[10px] overflow-hidden opacity-0 scale-95 pointer-events-none
         
          peer-hover:w-auto peer-hover:opacity-100 peer-hover:typewriter peer-hover:pointer-events-auto">
        {tech.text}
      </span>
    </div>
  );
